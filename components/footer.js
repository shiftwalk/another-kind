...
export default function Footer() {
  return (
    <footer className="bg-yellow text-black pb-3 lg:pb-8 relative">
      ...
      <Container>
        <div className="flex flex-wrap items-end relative z-10">
          <div className="w-full lg:w-auto mr-auto order-3 lg:order-1 text-center lg:text-left text-xs lg:text-base xl:text-xl xl:leading-none">
          ...
          <nav className="ml-auto flex space-x-2 xl:space-x-3 w-full text-sm lg:text-base xl:text-xl xl:leading-none lg:w-auto order-2 lg:order-3 justify-center lg:justify-end mb-1 lg:mb-0">
