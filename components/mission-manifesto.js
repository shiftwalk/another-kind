    ...
    <AnimatePresence>
      {manifestoOpen && (
        <div ref={missionOuterRef}>
          <m.button
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.85, transition: { duration: 0.6, ease: [0.83, 0, 0.17, 1], delay: scrollY.current > 100 ? 0.3 : 0 }}}
            ...
            <div className="overflow-x-hidden">
              <div className="whitespace-nowrap overflow-x-scroll" ref={missionInnerRef}>
                {items.map((e, i) => {
                  ...
                  return (
                    <div className={`aspect-[10/12] md:aspect-[16/10] lg:aspect-[10/11] lg:max-h-[57vh] inline-flex flex-wrap flex-grow-0 mr-5 w-[80%] lg:w-1/3 2xl:w-[30%] ${color} rounded-xl p-3 lg:p-5 whitespace-normal`} key={i}>
